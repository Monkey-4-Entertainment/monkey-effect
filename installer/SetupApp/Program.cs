...
internal sealed class SetupForm : Form
{
	...
	public SetupForm()
	{
		Text = "Monkeyeffect Setup 1.0.8.1";
		Width = 520;
		Height = 240;
	...
	private async System.Threading.Tasks.Task RunInstallAsync()
	{
		...
		try
		{
			...
			File.WriteAllText(Path.Combine(InstallDir, "VERSION.txt"), "Monkeyeffect 1.0.8.1 build " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
			try
			{
